    ...
    $.ajax({
        ...
        success: function (oData)
        {
            ...
            oData.forEach(function(el){
                ...
                '</td><td class=\"glyphicon glyphicon-edit\" onclick=\"GetModal(\'modals.php?modal_id=edit_employee&birth_date='+ el.birth_date + '&first_name='+ el.first_name +'&last_name='+ el.last_name +'&gender='+ el.gender + '\')\" style=\"display:table-cell\">' +
                '</td><td class=\"glyphicon glyphicon-trash\" onclick=\"GetModal(\'modals.php?modal_id=delete_employee\')\" style=\"display:table-cell\"></td></tr>')
            });
